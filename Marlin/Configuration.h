...
#define STRING_CONFIG_H_AUTHOR "(ChrisK, SKR1_4)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Chris MGN12"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 160.08
  #define DEFAULT_bedKi 27.89
  #define DEFAULT_bedKd 612.62
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 30, -12, -0.65 }
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIXELS 26       // Number of LEDs in the strip, larger of 2 strips if 2 neopixel strips are used
